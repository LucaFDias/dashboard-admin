...
const formSchema = z.object({
  ...
  price: z.coerce.number().min(1, { message: "Informe um valor" }),
  categoryId: z.string().min(1, { message: "Deve ter 1 ou mais caracteres" }),
  colorId: z.string().min(1, { message: "Deve ter 1 ou mais caracteres" }),
  sizeId: z.string().min(1, { message: "Deve ter 1 ou mais caracteres" }),
...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error(
        "Certifique-se de remover todos os itens do produto primeiro."
      );
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={loading} placeholder="R$" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
